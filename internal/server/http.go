...
func NewHTTP(runtime *app.Runtime, optionFns ...HTTPOption) http.Handler {
	...
	mux.HandleFunc("GET /v1/usage-resolvers", server.listUsageResolvers)
	mux.HandleFunc("POST /v1/plugins/{pluginID}/usage-resolvers/{resolverID}/refresh", server.refreshUsageResolver)
	...
	mux.HandleFunc("GET /v1/browser-resources", server.listBrowserResources)
	mux.HandleFunc("POST /v1/browser-resources", server.connectBrowserResource)
	mux.HandleFunc("DELETE /v1/browser-resources/{resourceID}", server.disconnectBrowserResource)
	mux.HandleFunc("GET /v1/browser-resources/{resourceID}/targets", server.listBrowserTargets)
