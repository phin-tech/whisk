...
T = TypeVar("T", bound="StartWorkItemRunRequest")


@_attrs_define
class StartWorkItemRunRequest:
    """
    Attributes:
        work_item_id (str):
        actor (str | Unset):
    ...
    prompt_template_id: str | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if prompt_template_id is not UNSET:
            field_dict["promptTemplateId"] = prompt_template_id
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        prompt_template_id = d.pop("promptTemplateId", UNSET)
        ...
        start_work_item_run_request = cls(
        ...
        start_work_item_run_request.additional_properties = d
        return start_work_item_run_request
