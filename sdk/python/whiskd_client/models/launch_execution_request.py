...
T = TypeVar("T", bound="LaunchExecutionRequest")


@_attrs_define
class LaunchExecutionRequest:
    """
    Attributes:
        work_item_id (str):
        actor (str | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        launch_execution_request.additional_properties = d
        return launch_execution_request
