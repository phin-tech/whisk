...
T = TypeVar("T", bound="WorkItemRunMetadata")


@_attrs_define
class WorkItemRunMetadata:
    """ """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        work_item_run_metadata.additional_properties = additional_properties
        return work_item_run_metadata
