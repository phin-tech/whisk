...
T = TypeVar("T", bound="UpdateProjectAttachmentRequestMeta")


@_attrs_define
class UpdateProjectAttachmentRequestMeta:
    """ """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        update_project_attachment_request_meta = cls()
        ...
        update_project_attachment_request_meta.additional_properties = (
            additional_properties
        )
        return update_project_attachment_request_meta
