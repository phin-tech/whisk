...
from ...models.import_workflow_definition_file_request import (
...
def _get_kwargs(
    *,
    body: ImportWorkflowDefinitionFileRequest,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/v1/workflow-definitions/import-file",
    }
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 201:
        response_201 = WorkflowDefinitionRecord.from_dict(response.json())
