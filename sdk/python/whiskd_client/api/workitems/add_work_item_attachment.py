...
from ...models.add_work_item_attachment_request import AddWorkItemAttachmentRequest
...
def _get_kwargs(
    work_item_id: str,
    *,
    body: AddWorkItemAttachmentRequest,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/v1/work-items/{work_item_id}/attachments".format(
