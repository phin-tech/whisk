...
from ...models.bind_work_item_worktree_request import BindWorkItemWorktreeRequest
...
def _get_kwargs(
    work_item_id: str,
    *,
    body: BindWorkItemWorktreeRequest,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/v1/work-items/{work_item_id}/bind-worktree".format(
